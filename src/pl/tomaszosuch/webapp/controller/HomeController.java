...
import pl.tomaszosuch.webapp.service.DiscoveryService;
...
public class HomeController extends HttpServlet {
    ...
    private void saveDiscoveriesInRequest(HttpServletRequest request) {
        ...
        List<Discovery> allDiscoveries = discoveryService.getAllDiscovery(new Comparator<Discovery>() {
            @Override
            public int compare(Discovery o1, Discovery o2) {
                int o1Vote = o1.getUpVote() - o2.getDownVote();
